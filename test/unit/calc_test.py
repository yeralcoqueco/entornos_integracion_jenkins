...
class TestCalculate(unittest.TestCase):
    ...
    def test_substract_method_returns_correct_result(self):
        ...
        self.assertEqual(6, self.calc.substract(2, -4))
        self.assertEqual(-8, self.calc.substract(-2, 6))
    ...
    def test_multiply_with_user_without_permissions(self, _validate_permissions):
